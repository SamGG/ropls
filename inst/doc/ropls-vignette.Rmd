...
captured by each component: it therefore depends on the total variance
of the dataMatrix *X* and of the percentage of this variance captured by the
component (indicated in the labels); it decreases when going to a component with
higher indice;
...
Note that the warning message is just a remainder that OPLS(-DA) models of a
