...
plot(sacurine.pca, typeVc = "x-score", parDevNewL = FALSE)
@
...
plot(sacurine.plsda, typeVc = "x-score", parDevNewL = FALSE)
@
\end{center}
...
plot(sacurine.oplsda, typeVc = "x-score", parDevNewL = FALSE)
@
\end{center}
